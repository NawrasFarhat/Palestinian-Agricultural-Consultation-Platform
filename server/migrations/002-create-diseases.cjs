...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    const tableExists = await queryInterface.showAllTables()
      .then(tables => tables.includes('diseases'));
    ...
    if (!tableExists) {
      ...
      console.log('ℹ️  Diseases table already exists, skipping creation');
    }
    ...
    await addIndexIfNotExists('diseases', ['name'], 'diseases_name');
    await addIndexIfNotExists('diseases', ['created_by'], 'diseases_created_by');
  },
